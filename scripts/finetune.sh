...
--data_dir /home/featurize/data/diffusion_dataset --attention_resolutions 16 \
...
--log_dir logs --lr 2e-8 --batch_size 2  \
--load_checkpoint ./weights/ffhq_baseline.pt \
--save_interval 100 --lr_anneal_steps 100000 --class_cond True
